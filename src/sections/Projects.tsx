      ...
      <div className="container">
        ...
        <div className="mt-10 md:mt-16">
          {projects.map(({ name, image }) => (
            ...
            >
              <div className="absolute bottom-0 left-0 w-full h-0 group-hover/project:h-full bg-stone-300 transition-all duration-700"></div>
              <div className="relative">
                ...
                <div className="mt-8 md:mt-0 flex justify-between items-center md:px-5 md:grid md:[grid-template-columns:1fr_300px_max-content] md:gap-8">
                  ...
                  <div className="relative">
                    <div className="absolute aspect-video w-full top-1/2 -translate-y-1/2 opacity-0 scale-75 group-hover/project:opacity-100 group-hover/project:scale-100 transition-all duration-500 z-10">
                    <Image
                    src={image}
                    alt={`${name} image`}
                    className="size-full object-cover"
