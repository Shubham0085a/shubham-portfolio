  ...
  return (
    <section className="section" id="testimonials">
      ...
      >
        ...
        <motion.span
          className="whitespace-nowrap self-end text-dark-blue-mix-700"
      ...
      <div className="container">
        ...
        <div className="flex gap-4 mt-6 lg:mt-10">
          <button
            className="border border-stone-400 size-11 inline-flex items-center justify-center rounded-full hover:bg-dark-blue-mix-900 hover:text-white hover:border-dark-blue-mix-700 transition-all duration-500"
